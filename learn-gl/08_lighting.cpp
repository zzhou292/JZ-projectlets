...
int main() {
  ...
  // lfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
  ...
  // ------------------------------------
  Shader lightingShader("../utils/1.colors.vs", "../utils/1.colors.fs");
  Shader lightCubeShader("../utils/1.light_cube.vs",
                         "../utils/1.light_cube.fs");
