...
public:
    ...
    void backtracking(vector<vector<int>>& res, vector<int>& cur, vector<int>& nums){
        // if cur vector has the same size as number, we finished constructing an array
        // attach to the result pool
